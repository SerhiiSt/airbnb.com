...
public class Test_2a1 {
    ...
    public static void setUp() throws Exception {
        ...
        log = Logger.getLogger(Test_2a1.class);
        data = ExcelDriver.getData("src/main/resources/testData.xls", "Test_2a1");
    ...
    public void test() throws Exception {
        ...
        airBnb.registrationPage.registrationUserWithEmail((String)data.get("firstName"), (String)data.get("lastName"), (String)data.get("email"), (String)data.get("pass"), (String)data.get("rememberMeComboBox"));
